...
Plugin Name: 300x600 Ad
Plugin URI: http://www.awesemthemes.com
Description: A widget that allows the display and configuration of a 300x600 Ad
Version: 1.0
Author: AWESEM
...
add_action( 'widgets_init', 'aw_ad300x600_widgets' );

/* -- Register widget -- */ 
function aw_ad300x600_widgets() { register_widget( 'AW_AD300X600_Widget' ); }
function load_ad_js_300x600(){
	wp_register_script( 'ad_js', get_template_directory_uri() . '/_widgets/ad.js', false);
	wp_enqueue_script( 'ad_js' );
}
add_action('admin_enqueue_scripts', 'load_ad_js_300x600');

/* -- Widget class -- */
class aw_ad300x600_widget extends WP_Widget {

	/* -- Widget setup -- */
	function AW_AD300X600_Widget() {
	
		/* -- Widget settings -- */
		$widget_ops = array( 'classname' => 'aw_ad300x600_widget', 'description' => __('A widget that allows the display and configuration of a 300x600 Ad', 'framework') );

		/* -- Widget control settings -- */
		$control_ops = array( 'id_base' => 'aw_ad300x600_widget' );

		/* -- Create the widget -- */
		parent::__construct( 'aw_ad300x600_widget', 'Deadline Responsive - '.__('300x600 Ad', 'framework'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array(
			'title' => '',
			'ad' => "http://cdn.awesem.com/images/300x600.png",
